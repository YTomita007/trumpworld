        ...
        switch($holdmark){
            case 'spade':
                switch($pickcardposition){
                    ...
                    case '01spades':
                        if($holdnum == $picknum + 1){
                            $spades[] = array_shift($inicol1);
                        }
                        break;
                    case '02hearts':
                        if($holdnum == $picknum + 1){
                            $hearts[] = array_shift($inicol1);
                        }
                        break;
                    case 'diamonds':
                        if($holdnum == $picknum + 1){
                            $diamonds[] = array_shift($inicol1);
                        }
                        break;
                    case '004clubs':
                        if($holdnum == $picknum + 1){
                            $clubs[] = array_shift($inicol1);
                        }
                        break;
                }
                break;
