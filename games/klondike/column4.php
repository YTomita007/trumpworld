<?php
                        if($deployflag == true){
                            if($inicol4cnt == 0){
                                ...
                                if($mycol4cnt == 0){
                                    echo "<div class='row-" . $inicol4cnt . "'>";
                                    echo "<input type='radio' name='pickcard' value='col4card" .$inicol4[0]['num'].$inicol4[0]['mark'] . "' id='col4card" . $inicol4cnt . "'>";
                                    echo "<label for='col4card" . $inicol4cnt . "'>";
