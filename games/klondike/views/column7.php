                        ...
                        if($deployflag == true){
                            if($inicol7cnt == 0){
                                ...
                                if($mycol7cnt == 1){
                                    ...
                                    echo "<input type='radio' name='pickcard' value='col7card" .$mycol7[0]['num'].$mycol7[0]['mark'] . "' id='mycol0070'>";
                                    ...
                                    echo "<div class='row-" . ($inicol7cnt + 1) .  "'>";
                                    echo "<img src='../cards/" . $inicol7[$inicol7cnt - 1]['mark'].$inicol7[$inicol7cnt - 1]['num'] . ".png'>";
                                    echo "</div>";
                                    for($i=0;$i<$mycol7cnt;$i++){
                                        echo "<div class='row-" . ($inicol7cnt + $i + 2) . "'>";
