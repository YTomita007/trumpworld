                        ...
                        if($deployflag == true){
                            if($inicol4cnt == 0){
                                ...
                                if($mycol4cnt == 1){
                                    ...
                                    echo "<input type='radio' name='pickcard' value='mycol004" .$mycol4[0]['num'].$mycol4[0]['mark'] . "' id='mycol0040'>";
                                    ...
                                    for($i=1;$i<$mycol4cnt;$i++){
                                        echo "<div class='row-" . ($inicol4cnt + $i) . "'>";
                                        echo "<img src='../cards/" . $mycol4[$i - 1]['mark'].$mycol4[$i - 1]['num'] . ".png'>";
                                        echo "</div>";
                                    }
                                    echo "<div class='row-" . ($inicol4cnt + $mycol4cnt) . "'>";
                                    echo "<input type='radio' name='pickcard' value='mycol004" .$mycol4[$mycol4cnt - 1]['num'].$mycol4[$mycol4cnt - 1]['mark'] . "' id='mycol0040'>";
                                    echo "<label for='mycol0040'>";
                                    echo "<img src='../cards/" . $mycol4[$mycol4cnt - 1]['mark'].$mycol4[$mycol4cnt - 1]['num'] . ".png'>";
                                    echo "</label>";
                                    echo "</div>";
