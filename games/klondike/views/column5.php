                        ...
                        if($deployflag == true){
                            if($inicol5cnt == 0){
                                ...
                                if($mycol5cnt == 1){
                                    ...
                                    echo "<input type='radio' name='pickcard' value='mycol005" .$mycol5[0]['num'].$mycol5[0]['mark'] . "' id='mycol0050'>";
                                    ...
                                    for($i=1;$i<$mycol5cnt;$i++){
                                        echo "<div class='row-" . ($inicol5cnt + $i) . "'>";
                                        echo "<img src='../cards/" . $mycol5[$i - 1]['mark'].$mycol5[$i - 1]['num'] . ".png'>";
                                        echo "</div>";
                                    }
                                    echo "<div class='row-" . ($inicol5cnt + $mycol5cnt) . "'>";
                                    echo "<input type='radio' name='pickcard' value='mycol005" .$mycol5[$mycol5cnt - 1]['num'].$mycol5[$mycol5cnt - 1]['mark'] . "' id='mycol0050'>";
                                    echo "<label for='mycol0050'>";
                                    echo "<img src='../cards/" . $mycol5[$mycol5cnt - 1]['mark'].$mycol5[$mycol5cnt - 1]['num'] . ".png'>";
                                    echo "</label>";
                                    echo "</div>";
