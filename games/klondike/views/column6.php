                        ...
                        if($deployflag == true){
                            if($inicol6cnt == 0){
                                ...
                                if($mycol6cnt == 1){
                                    ...
                                    echo "<input type='radio' name='pickcard' value='col6card" .$mycol6[0]['num'].$mycol6[0]['mark'] . "' id='mycol0060'>";
                                    ...
                                    echo "<div class='row-" . ($inicol6cnt + 1) .  "'>";
                                    echo "<img src='../cards/" . $inicol6[$inicol6cnt - 1]['mark'].$inicol6[$inicol6cnt - 1]['num'] . ".png'>";
                                    echo "</div>";
                                    for($i=0;$i<$mycol6cnt;$i++){
                                        echo "<div class='row-" . ($inicol6cnt + $i + 2) . "'>";
