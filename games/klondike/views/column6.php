<?php
                        if($deployflag == true){
                            if($inicol6cnt == 0){
                                ...
                                for($i=1;$i<$inicol6cnt + 1;$i++){
                                    echo "<div class='row-" . $i . "'>";
                                    echo "<img src='../cards/backcard.png'>";
                                    echo "</div>";
                                }
                                if($mycol6cnt == 1){
                                    echo "<div class='row-" . ($inicol6cnt + 1) . "'>";
                                    echo "<input type='radio' name='pickcard' value='mycol006" .$mycol6[0]['num'].$mycol6[0]['mark'] . "' id='mycol0060'>";
                                    echo "<label for='mycol0060'>";
                                    echo "<img src='../cards/" . $mycol6[0]['mark'].$mycol6[0]['num'] . ".png'>";
                                    echo "</label>";
                                    echo "</div>";
                                } else {
                                    for($i=1;$i<$mycol6cnt;$i++){
                                        echo "<div class='row-" . ($inicol6cnt + $i) . "'>";
                                        echo "<img src='../cards/" . $mycol6[$i - 1]['mark'].$mycol6[$i - 1]['num'] . ".png'>";
                                        echo "</div>";
                                    }
                                    echo "<div class='row-" . ($inicol6cnt + $mycol6cnt) . "'>";
                                    echo "<input type='radio' name='pickcard' value='mycol006" .$mycol6[$mycol6cnt - 1]['num'].$mycol6[$mycol6cnt - 1]['mark'] . "' id='mycol0060'>";
                                    echo "<label for='mycol0060'>";
                                    echo "<img src='../cards/" . $mycol6[$mycol6cnt - 1]['mark'].$mycol6[$mycol6cnt - 1]['num'] . ".png'>";
                                    echo "</label>";
                                    echo "</div>";
