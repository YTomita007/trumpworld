<?php
                        if($deployflag == true){
                            if($inicol3cnt == 0){
                                ...
                                if($mycol3cnt == 0){
                                    echo "<div class='row-" . $inicol3cnt . "'>";
                                    echo "<input type='radio' name='pickcard' value='col3card" .$inicol3[0]['num'].$inicol3[0]['mark'] . "' id='col3card" . $inicol3cnt . "'>";
                                    echo "<label for='col3card" . $inicol3cnt . "'>";
