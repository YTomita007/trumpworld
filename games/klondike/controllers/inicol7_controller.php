        ...
        switch($holdmark){
            case 'spade':
                switch($pickcardposition){
                    ...
                    case '01spades':
                        if($holdnum == $picknum + 1){
                            $spades[] = array_pop($inicol7);
                        }
                        break;
                    case '02hearts':
                        if($holdnum == $picknum + 1){
                            $hearts[] = array_pop($inicol7);
                        }
                        break;
                    case 'diamonds':
                        if($holdnum == $picknum + 1){
                            $diamonds[] = array_pop($inicol7);
                        }
                        break;
                    case '004clubs':
                        if($holdnum == $picknum + 1){
                            $clubs[] = array_pop($inicol7);
                        }
                        break;
                }
                break;
