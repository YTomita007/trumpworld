<?php
    ...
    function mycol5shift(
        ...
        $removekength = $mycol5length - $holdcardindex;
        ...
        switch($holdmark){
            case 'spade':
                switch($pickcardposition){
                    case 'col1card':
                        if($pickmark == "heart" || $pickmark == "diamond"){
                            if($holdnum == $picknum - 1){
                                $temp = array_slice($mycol5, $holdcardindex);
                                $tempcount = count($temp);
                                for($i=0;$i<$tempcount;$i++){
                                    $mycol5[] = array_shift($temp);
                                }
                                for($i=0;$i<$removekength;$i++){
                                    unset($mycol5[$i + $holdcardindex]);
                                }
                                if(($inicol5length > 0) && ($mycol5length == 0)){
                                    $mycol5[0] = array_pop($inicol5);
                                    unset($inicol5[$inicol5length - 1]);
                                }
                            }
                    ...
                    case '01spades':
                        if($holdnum == $picknum + 1){
                            $temp = array_slice($mycol5, $holdcardindex, 1);
                            $spades[] = array_shift($temp);
                            unset($mycol5[$holdcardindex]);
                            if(($inicol5length > 0) && ($mycol5length == 0)){
                                $mycol5[0] = array_pop($inicol5);
                                unset($inicol5[$inicol5length - 1]);
                            }
